...
input_file = "/home/wzq/scan-website/cmd/filtered_http_redirects_autoconfig.jsonl"#统计http最终获得的数量
output_csv = "/home/wzq/scan-website/cmd/autoconfig_scheme_summary.csv"  # 可选
