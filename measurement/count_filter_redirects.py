...
'''
input_file = "/home/wzq/scan-website/cmd/filtered_redirects_autodiscover.jsonl"  # 输入文件
output_file = "/home/wzq/scan-website/cmd/redirects_statistics_autodiscover.json"  # 存储统计结果的文件
