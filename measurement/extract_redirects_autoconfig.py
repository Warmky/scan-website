...
'''
# input_file = "init.jsonl"
# output_file = "filtered_redirects_autoconfig.jsonl"  # 存储符合条件的重定向链信息
...
extract_redirect_info("/home/wzq/scan-website/cmd/init.jsonl", "/home/wzq/scan-website/cmd/filtered_redirects_autoconfig.jsonl")
