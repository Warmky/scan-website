...
with open("/home/wzq/scan-website/cmd/redirects_statistics_autodiscover.json", "r", encoding="utf-8") as f:
...
for provider, customers in redirect_stats.items():
    ...
    is_small_provider = total_customers < 10 #10
...
df.to_csv("/home/wzq/scan-website/cmd/redirects_tld_statistics_autodiscover_10.csv", index=False, encoding="utf-8")
